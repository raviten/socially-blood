...
export default class MainLayout extends React.Component {
 ...
 changeBloodGroup(event, key, value) {
    ...
    this.setState({selectedBloodGroup: selectedBloodGroup});
  }
  ...
  submitForm() {
    if (this.state.mobile == "") {
      this.setState({errorMessageMobile: "This field is required"});
      return;
    } else if (this.state.mobile < 1000000000) {
      this.setState({errorMessageMobile: "Invalid Mobile Number"});
      return;
    } else {
